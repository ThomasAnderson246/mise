...
const navItems: NavItem[] = [
    ...
    {label: 'Recipes', path: 'recipes', icon: 'book', permission: {resource: 'recipe', action: "read"}},
    {label: 'Prep Lists', path: 'prep-lists', icon:'preplist', permission: {resource: 'preplist', action: 'read'} },
    {label: 'Ingredients', path: 'ingredients', icon:'', permission: {resource:'ingredient', action:'read'}},
    {label: 'Menu Items', path: 'menu-items', icon: '', permission: {resource:'menuitem', action:'read'}},
    {label: 'Categories', path: 'categories', icon: '', permission: {resource:'category', action:'read'}},
    {label: 'Allergens', path: 'allergens', icon:'', permission: {resource:'allergen', action:'read'}},
    {label: 'Unit Types', path: 'units', icon:'', permission: {resource:'unit', action:'read'}},
